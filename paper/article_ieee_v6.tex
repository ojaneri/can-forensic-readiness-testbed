...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../analysis/figures/reproducible_evidence_pipeline_v6.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{../analysis/figures/evidence_coverage_dashboard_v6.pdf}
...
\subsection{Wall-clock and python-can Virtual-Bus Evidence}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{../analysis/figures/python_can_virtual_bus_timing_v6.pdf}
\caption{python-can virtual-bus timing evidence from Experiments 011 and 012: generated traffic and external ICSim replay with send-to-receive latency profiles.}
